...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $userType = $_POST['userType']; // 'photographer' or 'service_seeker'
    ...
    if ($count > 0) {
        ...
        window.location='RegisterPhotographer.php'</script>";
        exit;
    }

    // Insert the user's data into the photographer table
    $query = "INSERT INTO photographer (photographerID, name, email, phonenumber, address, password, registration_date) VALUES ('$photographerID', '$name', '$email', '$phonenumber', '$address', ('$password'), NOW())";
            ...
            <table width="auto" border="1" class="imagetable">
                ...
                <tr>
                    <td colspan="2" style="text-align: center;">
                        <input type="radio" name="userType" value="photographer" required> Photographer
                        <input type="radio" name="userType" value="service_seeker" required> Service Seeker
                    </td>
                </tr>
            </table>
